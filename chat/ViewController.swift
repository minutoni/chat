...
//
//            let messageData = ["name": nameField.text!, "message": messageButton.text] //messageField.text!
...
//
//        //self.didPressSend(UIButton!, withMessageText: <#T##String!#>, date: <#T##Date!#>)
//
//        self.sendTextToDb(text: textView)
//    }
//
//    //=================================================代用案(カメラボタンを変えてみる)==================
